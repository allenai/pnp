...
image_dir ="file:///Users/jayantk/github/pnp/data/pascal_parts/pascal_parts_for_matching/images_resize2/"
...
with open(loss_json_file, 'r') as g:
    for line in g:
        j = json.loads(line)
        label_type = j["sourceLabel"]["diagramType"]
