...
./$SCRIPT_DIR/run.sh org.allenai.wikitables.TestWikiTablesCli --testData $DEV --model $MY_MODEL --beamSize $TEST_BEAM --derivationsPath $DERIVATIONS_PATH --maxDerivations $MAX_TEST_DERIVATIONS --seq2Tree &> $MY_DIR/dev_error_log.txt
